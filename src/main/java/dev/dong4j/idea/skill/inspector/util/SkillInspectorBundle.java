...
/**
 * Skill Inspector 资源包类
 * <p> 用于管理与国际化消息相关的资源文件, 提供便捷的方法来获取本地化消息字符串.
 * <p> 该类通过单例模式确保资源包的唯一性, 并支持动态加载和消息占位符替换.
 * <p> 使用方式:
 * <pre>{@code
 * String message = SkillInspectorBundle.message("welcome.message", "John");
 * }</pre>
 *
 * @author dong4j
 * @version 1.0.0
 ...
 * @since 1.0.0
 */
public class SkillInspectorBundle extends DynamicBundle {

    /** 资源文件名称, 用于加载多语言消息配置 */
    @NonNls
    private static final String BUNDLE = "messages.SkillInspectorBundle";

    /**
     * 资源包单例实例
     * <p> 用于全局访问国际化消息资源, 避免重复创建实例
     *
     * @see SkillInspectorBundle
     */
    private static final SkillInspectorBundle INSTANCE = new SkillInspectorBundle();
     ...
     *
     * @see SkillInspectorBundle#INSTANCE
     * @see DynamicBundle#DynamicBundle(String)
     */
    private SkillInspectorBundle() {
        super(BUNDLE);
    }
     ...
     * <p> 使用方式:
     * <pre>{@code
     * Supplier<String> message = SkillInspectorBundle.messagePointer("greeting", "Alice");
